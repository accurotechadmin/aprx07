...
Yesterday/today/tomorrow metaphor, reciprocal time, planning horizons, salience, memory, anticipation, and caveat-rich conceptual graphics. This first-draft secondary boot is intentionally MVP-level: complete enough to enter the mode safely, compact enough to refine later.

## When to use

Use this path when the user's task primarily needs: yesterday/today/tomorrow metaphor, reciprocal time, planning horizons, salience, memory, anticipation, and caveat-rich conceptual graphics. If another concern dominates, choose the smallest better-fitting boot path or combine at most two paths.

## Required reading order

1. [boot.md](boot.md) for primary boot state.
2. [the_essences.md](the_essences.md) for source hierarchy and canon.
3. [the_essences.md](the_essences.md)
4. [insightgraphsuite.md](insightgraphsuite.md)
5. [fibonacci_generation_lattice.md](fibonacci_generation_lattice.md)
6. [fibonacci_orange_pressing_recommendations.md](fibonacci_orange_pressing_recommendations.md)
...
```text
╔════════════════════════════════════════════════════════════════╗
║ FIBONACCI EXPLORER // NORMALIZED-TIME-METAPHOR            ║
║ METAPHOR MODE                                         ║
╚════════════════════════════════════════════════════════════════╝
...
3. Apply the featured principle: Keep yesterday/today/tomorrow interpretive and asymmetrical.
4. Inspect relevant inputs before producing new output: essence canon, time-metaphor notes, graph suite, and requested normalized quantity.
5. Build the factual skeleton before style, expansion, pedagogy, metaphor, or edits.
6. Produce the requested output: metaphor badge, asymmetry note, concept map, and caveat card.
...
|---|---|---|---|
| `metaphor-badge` | State metaphor status and normalized quantity. | Short checklist or notes section. | Read-only or draft-only unless explicitly authorized. |
| `asymmetry-note` | Include interval asymmetry. | Short checklist or notes section. | Read-only or draft-only unless explicitly authorized. |
| `concept-map` | Draft planning/salience/memory axes. | Short checklist or notes section. | Read-only or draft-only unless explicitly authorized. |
| `caveat-card` | List what the metaphor does not prove. | Short checklist or notes section. | Read-only or draft-only unless explicitly authorized. |

## MVP response contract

After loading this path, say: `Secondary boot complete: normalized-time-metaphor.boot.md`. Then summarize the active sources, selected actions, convention/range assumptions, and the next concrete step.
