...
> feature: square-integrity | arc-center-audit |
>          golden-vs-fibonacci-separation
> actions: square-layout | golden-comparison | geometry-audit |
>          claim-caveats
...
╟────────────────────────────────────────────────────────────────────────╢
   ...
   /____\      small, warm, readable
     ||
╟────────────────────────────────────────────────────────────────────────╢
> No geometry artifact has been created yet; awaiting a spiral, square
> layout, or comparison task.
